          ...
          <div class="row g-3 d-flex flex-row align-items-start justify-content-start">
            <div class="form-group col-6">
              <h5>Datos del Alumno</h5>
                ...
                <input  class="form-control" type="number" placeholder="Teléfono" name="Telfono" id="Telfono">

                <label for="Direccion">Dirección</label>
                <input  class="form-control" type="text" placeholder="Dirección" name="Direccion" id="Direccion">
            ...
            <h5>Datos del Representante</h5>
              ...
              <input type="number" class="form-control" name="CedulaR" id="CedulaR" placeholder="Cédula">
              ...
              <input  class="form-control" type="text" placeholder="Filiación" name="Filiacion" id="Filiacion" onkeypress="return validar(event)">

              <label for="TelfonoR">Teléfono </label>
              <input  class="form-control" type="tel" placeholder="Teléfono" name="TelfonoR" id="TelfonoR">

              <label for="DireccionR">Dirección</label>
              <input  class="form-control" type="text" placeholder="Dirección" name="DireccionR" id="DireccionR">
              ...
              <input  class="form-control" type="email" placeholder="Correo" name="CorreoR" id="CorreoR">
                <div id="areasRp" class="form-check d-none flex-column animate__animated animate__fadeInRight">
                  <h4 class=" mt-2">Seleccione las áreas repitientes</h4>
                  <div class="">
